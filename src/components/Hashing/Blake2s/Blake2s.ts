...
/**
 * @module Blake2s
 * Implements the Blake2s cryptographic hash function.
 * Blake2s is a second iteration of the blake algorithm
 *
...
export default class Blake2s implements HashFunction {
  key: Uint8Array | null = null
  outlen: number = 64
  context: Blake2sCTX
  /**
   * Constructor of the Blake2s engine
  ...
  constructor(outlen: number = 32, key?: Uint8Array) {
    ...
    this.context = blake2sInit(this.outlen, key)
  }
  ...
  update(input: Uint8Array) {
    blake2sUpdate(this.context, input)
    return this
  }
   ...
   */
  digest() {
    return Uint8Array.from(blake2sFinal(this.context))
  }
}
